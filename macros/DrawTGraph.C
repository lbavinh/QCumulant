                    ...
                    Double_t leg_x_high=0.55, Double_t leg_y_high=0.89,TString strModel="", TString strCent="", bool drawLeg=1, TString titleRatioPlot = "Ratio")
{
  ...
  gROOT->SetStyle("Pub");
	gROOT->ForceStyle();
	gStyle->SetPalette(kRedBlue);// kDarkRainBow, kVisibleSpectrum, kRainBow,kPastel, kCMYK, kBlueRedYellow, kBird (default), kDeepSea
	gStyle->SetErrorX(0);
                    ...
                    Double_t leg_x_high=0.55, Double_t leg_y_high=0.89,TString strModel="", TString *strCent = nullptr, Bool_t drawLeg=1, TString ratioToMethod="")
{
  ...
  gStyle->SetPadTickY(1);
	gROOT->ForceStyle();
	gStyle->SetPalette(kRedBlue);// kDarkRainBow, kVisibleSpectrum, kRainBow,kAtlantic, kRose, kArmy, kGreenRedViolet, kRedBlue
	gStyle->SetErrorX(0);
