TProfile *PlotV2ScalarProductIntegrated(TProfile3D* &prV2,
...
TProfile *PlotV2ScalarProductDifferentialVersusPt(TProfile3D *const &prV2,
...
TProfile *PlotV2ScalarProductDifferentialVersusEta(TProfile3D*const &prV2,
                           const double pt_low = 0.2,
                           const double pt_high = 3.0,
                           const double cent_low = 10,
                           const double cent_high = 40)
...
void PlotV2ScalarProduct(TString inputFileName = "SecondRun.root")
{
  ...
  TProfile *prV2diffpt = PlotV2ScalarProductDifferentialVersusPt(pr,10,40,1.5);
  ...
  TProfile *prV2diffpt4080 = PlotV2ScalarProductDifferentialVersusPt(pr,40,80,1.5);
  ...
  TProfile *prV2int = PlotV2ScalarProductIntegrated(pr,0.2,3.5,1.5);
  ...
  TProfile *prV2diffEta = PlotV2ScalarProductDifferentialVersusEta(prClone, 0.2, 3.5, 10, 40);
